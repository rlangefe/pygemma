...
def manhattan_plot(df, output_path):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_path, "gemma_linear_wald_Manhattan.png"))
    plt.clf()
...
def qq_plot(df, output_path):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_path, "gemma_linear_wald_qq.png"))
    plt.clf()
...
if __name__ == '__main__':
    ...
    if len(df) > 0:
        ...
        plt.savefig(os.path.join(args.output, "pygemma_vs_gemma_linear.png"))
        plt.clf()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(args.output, "pygemma_vs_gemma_linear_p.png"))
        plt.clf()
        ...
        plt.title(f'PyGEMMA vs. GEMMA - {os.path.basename(args.output)}')
        plt.tight_layout()
        plt.savefig(os.path.join(args.output, "pygemma_vs_gemma_linear_beta.png"))
        plt.clf()
